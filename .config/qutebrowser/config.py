...
c.url.searchengines['DEFAULT'] = 'https://www.google.com/search?q={}&udm=14'
...
# config.bind('b', 'bookmark-load', mode='normal')

# dark mode
config.set("colors.webpage.darkmode.enabled", True)
config.set("colors.webpage.bg", "black")

# zoom when using laptop
# config.set("zoom.default", "146%")
